...
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/auth.service */ "./src/app/_shared/services/auth.service.ts");
...
let LoginComponent = class LoginComponent {
    constructor(fb, gs, route, router, as) {
        this.fb = fb;
        this.gs = gs;
        this.route = route;
        this.router = router;
    ...
    onClickedSubmit() {
        ...
        if (this.fg.valid) {
            ...
            this.as.login({
                ...
                this.as.verify(localStorage.getItem(src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].tokenName)).subscribe(success => this.router.navigate([this.returnUrl]), error => this.as.logout());
            }, err => {
...
LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-login',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./login.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/_shared/components/login/login.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./login.component.scss */ "./src/app/_shared/components/login/login.component.scss")).default]
    })
], LoginComponent);
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _login_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./login.component */ "./src/app/_shared/components/login/login.component.ts");
...
//# sourceMappingURL=_shared-components-login-login-module-es2015.js.map