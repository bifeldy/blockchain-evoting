...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function srcApp_pagesHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_services_chain_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function HomeComponent(gs, es, router, cs) {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.cs.getLatestBlock(1, 5).subscribe(function (res) {
            _this.latestBlocks = res.results.sort(function (a, b) {
