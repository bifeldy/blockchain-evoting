...
/* harmony import */ var src_app_shared_services_chain_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/_shared/services/chain.service */ "./src/app/_shared/services/chain.service.ts");
...
let AdminComponent = class AdminComponent {
    constructor(router, el, us, gs, cs) {
        this.router = router;
        this.el = el;
        this.us = us;
        this.gs = gs;
    ...
    getSigners() {
        this.cs.getSigners().subscribe(res2 => {
            this.signers = res2.results;
            this.signerTable = $('#signerTable').DataTable();
        });
    }
};
