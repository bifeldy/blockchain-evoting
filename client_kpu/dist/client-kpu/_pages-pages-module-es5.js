...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["_pages-pages-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcApp_pagesPagesComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcApp_pagesPagesComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcApp_pagesPagesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*! ../_shared/services/global.service */
    "./src/app/_shared/services/global.service.ts");

    var PagesComponent =
    /*#__PURE__*/
    function () {
      function PagesComponent(router, gs, as) {
    ...
    PagesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/_pages/pages.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./pages.component.css */
      "./src/app/_pages/pages.component.css")).default]
    })], PagesComponent);
    /***/
  },
  ...
  /***/
  function srcApp_pagesPagesModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_guard_auth_guard_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../_shared/guard/auth-guard.service */
    ...
    var _shared_models_role__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../_shared/models/role */
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          ...
          [__webpack_require__.e("default~admin-admin-module~election-election-module~fund-fund-module~home-home-module~my-election-my~396f8003"), __webpack_require__.e("admin-admin-module")]).then(__webpack_require__.bind(null,
          /*! ./admin/admin.module */
          "./src/app/_pages/admin/admin.module.ts")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          ...
          [__webpack_require__.e("default~admin-admin-module~election-election-module~fund-fund-module~home-home-module~my-election-my~396f8003"), __webpack_require__.e("default~election-election-module~home-home-module~my-election-my-election-module"), __webpack_require__.e("home-home-module")]).then(__webpack_require__.bind(null,
          /*! ./home/home.module */
          "./src/app/_pages/home/home.module.ts")).then(function (m) {
            return m.HomeModule;
          });
        },
        data: {
        ...
        loadChildren: function loadChildren() {
          ...
          /*! import() | explorer-explorer-module */
          "explorer-explorer-module").then(__webpack_require__.bind(null,
          /*! ./explorer/explorer.module */
          "./src/app/_pages/explorer/explorer.module.ts")).then(function (m) {
            return m.ExplorerModule;
          });
        },
        data: {
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | fund-fund-module */
          [__webpack_require__.e("default~admin-admin-module~election-election-module~fund-fund-module~home-home-module~my-election-my~396f8003"), __webpack_require__.e("fund-fund-module")]).then(__webpack_require__.bind(null,
          /*! ./fund/fund.module */
          "./src/app/_pages/fund/fund.module.ts")).then(function (m) {
            return m.FundModule;
          });
        },
        data: {
        ...
        loadChildren: function loadChildren() {
          ...
          "./src/app/_pages/status/status.module.ts")).then(function (m) {
            return m.StatusModule;
          });
        },
        data: {
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | election-election-module */
          [__webpack_require__.e("default~admin-admin-module~election-election-module~fund-fund-module~home-home-module~my-election-my~396f8003"), __webpack_require__.e("default~election-election-module~home-home-module~my-election-my-election-module"), __webpack_require__.e("election-election-module")]).then(__webpack_require__.bind(null,
          /*! ./election/election.module */
          "./src/app/_pages/election/election.module.ts")).then(function (m) {
            return m.ElectionModule;
          });
        },
        data: {
          title: 'All Election',
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | my-election-my-election-module */
          [__webpack_require__.e("default~admin-admin-module~election-election-module~fund-fund-module~home-home-module~my-election-my~396f8003"), __webpack_require__.e("default~election-election-module~home-home-module~my-election-my-election-module"), __webpack_require__.e("my-election-my-election-module")]).then(__webpack_require__.bind(null,
          /*! ./my-election/my-election.module */
          "./src/app/_pages/my-election/my-election.module.ts")).then(function (m) {
            return m.MyElectionModule;
          });
        },
        canActivate: [_shared_guard_auth_guard_service__WEBPACK_IMPORTED_MODULE_4__["AuthGuardService"]],
        data: {
        ...
        path: '**',
        redirectTo: 'home' // loadChildren: () => import('./not-found/not-found.module').then(m => m.NotFoundModule)
  ...
  /***/
  function srcApp_sharedGuardAuthGuardServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(AuthGuardService, [{
        ...
        value: function canActivate(route, state) {
          var currentUser = this.as.currentUserValue;
...
//# sourceMappingURL=_pages-pages-module-es5.js.map