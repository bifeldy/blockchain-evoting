...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcApp_sharedComponentsHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function HeaderComponent(api, as, us) {
      ...
      _createClass(HttpErrorInterceptor, [{
        ...
        value: function intercept(request, next) {
          ...
          return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) {
            _this3.gs.log("[INTERCEPT_ERROR-".concat(e.status, "]"), e.statusText);
      ...
      _createClass(AuthService, [{
        ...
        value: function verify(token) {
          ...
          return this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl, "/verify"), {
            ...
            _this5.currentUserSubject.next(respVerify.result.user);

            var userSession = JSON.stringify(respVerify.result.user);

            var userEncrypted = _this5.crypt.encrypt(userSession, token);
      ...
      _createClass(UserService, [{
        ...
        value: function getAccountBalance(accountAddress) {
          ...
          this.api.getData("/coinbase?accountAddress=".concat(accountAddress)).subscribe(function (res) {
            _this6.gs.log('[COINBASE]', res);

            _this6.myCoinBase = res.result;
          });
        }
      }, {
        key: "requestCoin",
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~_shared-components-login-login-module~_shared-components-register-register-module~admin-admi~797106d1"), __webpack_require__.e("_shared-components-login-login-module")]).then(__webpack_require__.bind(null,
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~_shared-components-login-login-module~_shared-components-register-register-module~admin-admi~797106d1"), __webpack_require__.e("_shared-components-register-register-module")]).then(__webpack_require__.bind(null,
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (event) {
            ...
            _this7.updateSitePage(event.title, event.description, event.keywords);
          });
