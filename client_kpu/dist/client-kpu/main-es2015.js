...
/* harmony import */ var _services_chain_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../services/chain.service */ "./src/app/_shared/services/chain.service.ts");
/* harmony import */ var _services_global_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../services/global.service */ "./src/app/_shared/services/global.service.ts");
...
let HeaderComponent = class HeaderComponent {
    constructor(router, api, gs, as, us, cs) {
        this.router = router;
        this.api = api;
        this.gs = gs;
        this.as = as;
    ...
    searchHash() {
        ...
        this.cs.getDetailBlock(this.searchQuery).subscribe(res1 => {
            this.gs.log('[Block]', res1);
            if (!res1.result) {
                this.cs.getDetailTransaction(this.searchQuery).subscribe(res2 => {
...
let ApiService = class ApiService {
    ...
    downloadFile(path) {
        ...
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl + path, {
            observe: 'response',
            responseType: 'blob'
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => {
...
ChainService.ctorParameters = () => [
    { type: _api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
];
ChainService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], ChainService);
