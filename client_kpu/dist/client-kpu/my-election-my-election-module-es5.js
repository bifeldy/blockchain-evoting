      ...
      _createClass(CreateElectionComponent, [{
        ...
        value: function initializeForm() {
          ...
          this.fg = this.fb.group({
            ...
            electionImage: [data ? data.electionImage : 'http://via.placeholder.com/144x81', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([])],
      ...
      _createClass(MyElectionComponent, [{
        ...
        value: function initDataTable() {
          ...
          $('#joinedElectionTable tbody').on('click', function (event) {
            var electionData = _this25.joinedElectionTable.row($(event.target).parents('tr')).data();

            _this25.router.navigateByUrl("/election/".concat(electionData.id));
          });
          $('#createdElectionTable tbody').on('click', function (event) {
            var electionData = _this25.createdElectionTable.row($(event.target).parents('tr')).data();
