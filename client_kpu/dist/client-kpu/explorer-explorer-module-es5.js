...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["explorer-explorer-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcApp_pagesExplorerBlockDetailBlockDetailComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcApp_pagesExplorerTransactionDetailTransactionDetailComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcApp_pagesExplorerBlockDetailBlockDetailComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcApp_pagesExplorerBlockDetailBlockDetailComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BlockDetailComponent", function () {
    ...
    var src_app_shared_services_chain_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var BlockDetailComponent =
    /*#__PURE__*/
    function () {
      function BlockDetailComponent(router, route, gs, cs) {
        _classCallCheck(this, BlockDetailComponent);
      ...
      _createClass(BlockDetailComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this = this;

          this.route.paramMap.subscribe(function (params) {
            _this.cs.getDetailBlock(params.get('blockHash')).subscribe(function (res1) {
              _this.gs.log('[BLOCK]', res1);

              _this.block = res1.result;

              if (!_this.block) {
                _this.router.navigateByUrl('/explorer');
              } else {
                _this.cs.getBlockSigner(params.get('blockHash')).subscribe(function (res2) {
                  _this.signers = res2.results;
                });
              }
            }, function (err) {
              _this.router.navigateByUrl('/explorer');
    ...
    BlockDetailComponent.ctorParameters = function () {
      return [{
    ...
    BlockDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-block-detail',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./block-detail.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/_pages/explorer/block-detail/block-detail.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./block-detail.component.css */
      "./src/app/_pages/explorer/block-detail/block-detail.component.css")).default]
  ...
  function srcApp_pagesExplorerExplorerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_services_chain_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/_shared/services/chain.service */
    "./src/app/_shared/services/chain.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function ExplorerComponent(gs, cs) {
      ...
      _createClass(ExplorerComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.refreshBlockLive = setInterval(function () {
            _this2.getLatestBlock(_this2.page, _this2.row);
          }, 5000);
        }
      }, {
        key: "ngOnDestroy",
        ...
        value: function getLatestBlock(page, row) {
          ...
          this.cs.getLatestBlock(page, row).subscribe(function (res) {
            _this3.gs.log("[EXPLORER-BLOCK]", res);

            _this3.latestBlocks = res.results.sort(function (a, b) {
    ...
    ExplorerComponent.ctorParameters = function () {
      return [{
  ...
  function srcApp_pagesExplorerExplorerModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _block_detail_block_detail_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./block-detail/block-detail.component */
    "./src/app/_pages/explorer/block-detail/block-detail.component.ts");
    /* harmony import */


    var _transaction_detail_transaction_detail_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./transaction-detail/transaction-detail.component */
    ...
    ExplorerModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_explorer_component__WEBPACK_IMPORTED_MODULE_4__["ExplorerComponent"], _block_detail_block_detail_component__WEBPACK_IMPORTED_MODULE_5__["BlockDetailComponent"], _transaction_detail_transaction_detail_component__WEBPACK_IMPORTED_MODULE_6__["TransactionDetailComponent"]],
  ...
  /***/
  function srcApp_pagesExplorerTransactionDetailTransactionDetailComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcApp_pagesExplorerTransactionDetailTransactionDetailComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function TransactionDetailComponent(router, route, gs, cs) {
      ...
      _createClass(TransactionDetailComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.paramMap.subscribe(function (params) {
            _this4.cs.getDetailTransaction(params.get('transactionHash')).subscribe(function (res) {
              _this4.gs.log('[TRANSACTION]', res);

              _this4.transactions = res.result;

              if (!_this4.transactions) {
                _this4.router.navigateByUrl('/explorer');
              }
            }, function (err) {
              _this4.router.navigateByUrl('/explorer');
            });
    ...
    TransactionDetailComponent.ctorParameters = function () {
      return [{
        type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]
      }, {
        type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]
    ...
    TransactionDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/_pages/explorer/transaction-detail/transaction-detail.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./transaction-detail.component.css */
      "./src/app/_pages/explorer/transaction-detail/transaction-detail.component.css")).default]
