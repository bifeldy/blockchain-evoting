...
/* harmony import */ var src_app_shared_services_auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/_shared/services/auth.service */ "./src/app/_shared/services/auth.service.ts");
...
let FundComponent = class FundComponent {
    constructor(as, us, router, gs) {
        ...
        this.gs = gs;
        this.currUser = null;
        this.urlExport = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl}/user/export?jwt=${localStorage.getItem(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].tokenName)}`;
