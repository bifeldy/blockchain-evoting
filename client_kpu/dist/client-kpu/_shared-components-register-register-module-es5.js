        ...
        value: function settingUpEthereumAccount() {
          ...
          if (this.fg.value.ethAccount === 'tidak') {
            this.us.newEthAccount({
              ...
              _this10.registerInfo = res.result.account.pubKey;
              _this10.ethereumAddressCreatedImported = res.result.account.pubKey; // const receipt = res.result.trxTransferCoin;
